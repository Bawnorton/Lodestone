...
import team.lodestar.lodestone.client.systems.rendering.ghost.GhostBlockOptions;
import team.lodestar.lodestone.client.systems.rendering.ghost.GhostBlockRenderer;
...
public class GhostBlockHandler {
    ...
    public static void renderGhosts(MatrixStack matrixStack) {
        GHOSTS.forEach((slot, ghostBlockEntry) -> {
            GhostBlockRenderer ghost = ghostBlockEntry.ghost;
            ghost.render(matrixStack, ghostBlockEntry.options);
        });
    }
