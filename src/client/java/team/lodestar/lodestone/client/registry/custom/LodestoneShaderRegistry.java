...
public final class LodestoneShaderRegistry {
    public static final ShaderHolder SILKSTONE_TEXTURE = new ShaderHolder(Lodestone.id("lodestone_texture"), VertexFormats.POSITION_COLOR_TEXTURE_LIGHT, "LumiTransparency");
